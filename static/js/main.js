...
function setupWebSocket(chatUserId) {
    ...
    socket.on('receive_message', function(data) {
        ...
        showNotification('Nuevo mensaje', data.message, chatUserId);
    });
}
...
// Modificar loadChatList para manejar la selección de chats
...
// Actualizar sendMessage para usar el chatUserId
function sendMessage(chatUserId) {
    const messageInput = document.getElementById('message-input');
    const message = messageInput.value.trim();
    if (message !== '') {
